...
public class LanguageUtilTest {
    ...
    void test() throws IOException {
        ...
        var activity = activityUtil.convertYamlFileToActivity(new FileInputStream(
                mockProperties.getBotDirectory() + "/start.yaml"
        ));
        var util = new LanguageUtil(mockProperties);
        String translatedLine = util
                .getTranslatedLineForActivity("ua", activity.activityName(), activity.content()[0].label());
